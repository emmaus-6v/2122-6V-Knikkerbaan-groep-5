...
char WIFI_NETWERK[] = "ziggo";
char WIFI_WACHTWOORD[] = "Slagtand197";
char SERVER_DOMEINNAAM[] = "3000-harlequin-emu-0yiuwyp0.ws-eu17.gitpod.io";    // domeinnaam van gitpod-server, zoals 3000-lavendel-bla-bla.gitpod.io
