...
const int BOVEN_POORT_PIN = 9;    // pin van servo die bovenste poort regelt
...
char SERVER_DOMEINNAAM[] = "3000-coral-beaver-21ti9b6q.ws-eu17.gitpod.io";    // domeinnaam van gitpod-server, zoals 3000-lavendel-bla-bla.gitpod.io
